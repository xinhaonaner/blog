...
<img style="margin: 0 15px 0 0" class="img-responsive author-img" src="https://cdn.weifengchuxing.com/app/upload/client/2018-12-02/QxR8v3S6dtWtMx6ESq6KOmmOOFUZfK9ATncB5Mji.png" title="{{ $user->first_name .  ' ' . $user->last_name }}">
